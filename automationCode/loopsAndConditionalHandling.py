...
#         # TODO add conditionalgrammar here, then in conditional grammar add the referenceCount as
#         self.conditional_rules = ''
#         # next in conditional Grammar, then in the end print, conditional grammar and the accumulative conditional rules
...
#                 handling_object = loopsAndConditionalHandling(
#                     line, 'if', random_word)
...
#                 object_before_ending_if.addToConditionalRules(
#                     ending_if_object.handleEndOfConditional())
#                 object_before_ending_if.addToConditionalGrammar(ending_if_object.refereceCount)
...
#                 else_conditional = loopsAndConditionalHandling(
#                     line, 'if', random_word)
#                 if_conditional_inside_else = loopsAndConditionalHandling(
#                     line, 'if', random_word_for_new_if)
#                 else_conditional.addToConditionalGrammar(
#                     if_conditional_inside_else)
...
#                 number_of_closing_brackets -= 1
#                 # hit and unnecessarily remove another element from stack.
#                 self.addToConditionalStack(
#                     loopsAndConditionalHandling(line, 'if', random_word))
...
#                 inner_conditional = loopsAndConditionalHandling(
#                     line, 'if', random_word)
...
#                         inner_if_condition.addToConditionalStack(
...
#             # TODO this can also become a method
#             current_top_object = self.conditional_stack.pop()
#             # TODO check whether I should remove one here with current logic
...
#     def getConditionalRules(self):
#         return self.conditional_rules

#     def addToConditionalRules(self, formatedGrammar):
#         self.conditional_rules += f"\n{formatedGrammar} "
